{
  ...
  '#':: d.pkg(name='controlPlaneProvider', url='', help='"ControlPlaneProvider is the Schema for the controlplaneproviders API."'),
  ...
  '#new':: d.fn(help='new returns an instance of ControlPlaneProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.cluster.x-k8s.io/v1alpha2',
    kind: 'ControlPlaneProvider',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ControlPlaneProviderSpec defines the desired state of ControlPlaneProvider."'),
  spec: {
