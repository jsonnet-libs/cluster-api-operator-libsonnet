{
  ...
  '#':: d.pkg(name='bootstrapProvider', url='', help='"BootstrapProvider is the Schema for the bootstrapproviders API."'),
  ...
  '#new':: d.fn(help='new returns an instance of BootstrapProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.cluster.x-k8s.io/v1alpha2',
    kind: 'BootstrapProvider',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BootstrapProviderSpec defines the desired state of BootstrapProvider."'),
  spec: {
