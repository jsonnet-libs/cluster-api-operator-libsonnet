{
  ...
  '#':: d.pkg(name='runtimeExtensionProvider', url='', help='"RuntimeExtensionProvider is the Schema for the RuntimeExtensionProviders API."'),
  ...
  '#new':: d.fn(help='new returns an instance of RuntimeExtensionProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.cluster.x-k8s.io/v1alpha2',
    kind: 'RuntimeExtensionProvider',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RuntimeExtensionProviderSpec defines the desired state of RuntimeExtensionProvider."'),
  spec: {
