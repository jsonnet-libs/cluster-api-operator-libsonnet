{
  ...
  '#':: d.pkg(name='infrastructureProvider', url='', help='"InfrastructureProvider is the Schema for the infrastructureproviders API."'),
  ...
  '#new':: d.fn(help='new returns an instance of InfrastructureProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.cluster.x-k8s.io/v1alpha2',
    kind: 'InfrastructureProvider',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"InfrastructureProviderSpec defines the desired state of InfrastructureProvider."'),
  spec: {
