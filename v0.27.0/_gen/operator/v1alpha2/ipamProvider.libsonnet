{
  ...
  '#':: d.pkg(name='ipamProvider', url='', help='"IPAMProvider is the Schema for the IPAMProviders API."'),
  ...
  '#new':: d.fn(help='new returns an instance of IPAMProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.cluster.x-k8s.io/v1alpha2',
    kind: 'IPAMProvider',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"IPAMProviderSpec defines the desired state of IPAMProvider."'),
  spec: {
