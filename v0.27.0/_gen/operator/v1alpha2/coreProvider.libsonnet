{
  ...
  '#':: d.pkg(name='coreProvider', url='', help='"CoreProvider is the Schema for the coreproviders API."'),
  ...
  '#new':: d.fn(help='new returns an instance of CoreProvider', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.cluster.x-k8s.io/v1alpha2',
    kind: 'CoreProvider',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"CoreProviderSpec defines the desired state of CoreProvider."'),
  spec: {
