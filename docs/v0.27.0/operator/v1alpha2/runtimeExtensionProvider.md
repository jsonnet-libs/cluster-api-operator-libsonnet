---
permalink: /v0.27.0/operator/v1alpha2/runtimeExtensionProvider/
---

# operator.v1alpha2.runtimeExtensionProvider
...
new returns an instance of RuntimeExtensionProvider
